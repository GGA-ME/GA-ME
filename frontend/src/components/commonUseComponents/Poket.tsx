    ...
    <div className='fixed right-5 flex flex-col items-center justify-center h-screen'>
      ...
      <div className={`${style.neonBorder} -translate-y-20 flex flex-col items-center justify-center px-8 mt-44 rounded-full border-r-2 border-l-2 bg-gray-900 text-white z-40 h-96`}
        style={{ height: '28rem' }}>
                ...
                {/* Info아이콘 */}
      <section className="fixed top-1 justify-center items-center mb-4"> {/* mb-4는 하단 요소와의 간격 조정 */}
        <div className="group flex justify-center transition-all rounded-full bg-gray-200 p-1">
          ...
          <span className="w-40 h-2 absolute -translate-y-20 opacity-0 group-hover:opacity-100 group-hover:-translate-y-28 duration-700 text-sm">
            <img src={'/Cart.png'} alt="Cart" /> 박스 아이콘을 클릭하여게임을 2개 이상추가후 Mix! 버튼을 눌러 비슷한 장르의 게임을 찾아보세요!
          </span>
        </div>
      </section>
