    ...
    return (
        <div className={styles.container}    
            ...
            <div className={styles.imageContainer}>
                <img src={screenshots[selectedImageIndex]?.path_full} alt="Screenshot" className={styles.mainImage} />
            </div>
                ...
                <div className={styles.imageList}>
                    {screenshots.map((screenshot, index) => (
                        <img
                            ...
                            className={`${styles.imageItem} ${index === selectedImageIndex ? styles.active : ''}`}
