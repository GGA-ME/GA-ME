...
1. 카카오 로그인
2. 자체 평가 기준에 따른 인기 게임 추천
3. 자체 평가 기준 + 모든 사용자 패턴 기준 '최신' 인기 게임 추천
4. 사용자 행동 패턴에 따른 인기 게임 추천 (맞춤)
5. 태그 기반 필터링 게임 목록
6. 게임명 검색
7. 사용자 지정 N개 게임에 대한 태그 기반 게임 추천
8. 스팀 게임 세일 정보 제공
9. 사용자 선호 태그 기반 게임의 뉴스 정보
10. 사용자 선호 태그 및 가중치 정보
11. 사용자 선호 게임 목록
12. 사용자 행동 패턴에 따른 가중치 판단 및 가치 반영
13. 스팀 API 기반 게임 디테일 정보 제공
14. 유튜브 API 기반 게임 공식 트레일러 영상 제공
15. 스팀 API 리뷰 내 플레이타임 기반 시간 별 만족도 그래프 제공
16. 스팀 API 리뷰 내 키워드 기반 워드 클라우드 제공
